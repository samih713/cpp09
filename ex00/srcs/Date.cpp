...
Date::Date (const Date &other)
	: isLeap (other.isLeap), year (other.year), month (other.month), day (other.day)
{
}
...
{
	output_s << date.get_year () << dateDelim << date.get_month () << dateDelim << date.get_day ();
	return output_s;
}
